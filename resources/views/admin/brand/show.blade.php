            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/admin/brand/' . $brand->id . '/edit') }}" title="Edit brand"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Title </th><td> {{ $brand->title }} </td></tr><tr><th> Slug </th><td> {{ $brand->slug }} </td></tr><tr><th> Note </th><td> {{ $brand->note }} </td></tr>
                                </tbody>
                            </table>
                        </div>
