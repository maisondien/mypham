            ...
            <div class="container">
                ...
                <div class="nav-inner">
                    ...
                    <ul id="nav" class="hidden-xs">
                        ...
                        <li class="drop-menu"> <a href="#"> <span>MỸ PHẨM</span> </a>
                            <ul>
                        ...
                        <li class="mega-menu"> <a class="level-top" href="shop_grid.html"><span>THỰC PHẨM CHỨC NĂNG</span></a>
                                    ...
                                    <div class="nav-block jtv-nav-block-center">
                                        <div class="col-1">
                                            <ul class="level0">
                                                ...
                                                <li class="parent item"> <a href="shop_grid.html"><span>BÁNH KẸO</span></a>
                                                    <ul class="level1">
                                        ...
                                        <div class="col-2">
                                            <div class="jtv-nav-image1"> <a title="" href="#"><img alt="menu_image" src="/public/frontend/images/menu-img1.jpg"> </a> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="mega-menu"> <a class="level-top" href="shop_grid.html"><span>BÁNH KẸO</span></a>
                            <div class="jtv-menu-block-wrapper">
                                <div class="jtv-menu-block-wrapper2">
                                    <div class="nav-block jtv-nav-block-center">
                                        <ul class="level0">
                                    ...
                                    <div class="jtv-nav-banner">
                                        <div class="jtv-banner-box">
                                            <div class="jtv-nav-banner-img"> <a href="#"><img src="/public/frontend/images/menu-img2.jpg" alt="Handbag"> </a> </div>
                                        </div>
                                        <div class="jtv-banner-box">
                                            <div class="jtv-nav-banner-img"> <a href="#"><img src="/public/frontend/images/menu-img3.jpg" alt="Handbag"> </a> </div>
                                        </div>
                                        <div class="jtv-banner-box jtv-banner-box_last">
                                            <div class="jtv-nav-banner-img"> <a href="#"><img src="/public/frontend/images/menu-img4.jpg" alt="Handbag"> </a> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li class="mega-menu"> <a class="level-top" href="shop_grid.html"><span>NƯỚC UỐNG</span></a>
                            <div class="jtv-menu-block-wrapper">
                                <div class="jtv-menu-block-wrapper2">
                                    <div class="nav-block jtv-nav-block-center">
                                        <ul class="level0">
                        ...
                        <li class="mega-menu"> <a class="level-top" href="shop_grid.html"><span>Drinks</span></a>
                            <div class="jtv-menu-block-wrapper">
                                <div class="jtv-menu-block-wrapper2">
                                    ...
                                    <div class="nav-block nav-block-right std jtv-menu-box-right"><img src="/public/frontend/images/menu-img5.jpg" alt="menu img"> </div>
                                </div>
                            </div>
                        </li>
